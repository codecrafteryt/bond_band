/*
  ...
  Author: Ameer Salman
  ---------------------------------------
  Description: custom my color code
*/
...
class MyColors {
  // Primary Colors
  static const Color primary = Color.fromRGBO(251, 188, 27, 1); // rgba(255, 192, 0, 1)
  static const Color primary1 = Color.fromRGBO(238, 158, 3, 1); // rgba(255, 192, 0, 1)
  static const Color primary2 = Color.fromRGBO(205, 148, 3, 1); // rgba(255, 192, 0, 1)
  ...
  // Secondary Colors
  static const Color secondaryLight = Color(0xFFFFE082); // rgba(255, 224, 130, 1)
  static const Color secondaryLighter = Color(0xFFFFF3E0); // rgba(255, 243, 224, 1)
